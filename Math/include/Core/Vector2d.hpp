...
namespace HANDYMATH_NS {
	...
	FORCEINLINE Vector2d Vector2d::OrthoCW()  const { return YX() * NegUnitY(); } // Vector2d(Y, -X);
	FORCEINLINE Vector2d Vector2d::OrthoCCW() const { return YX() * NegUnitX(); } // Vector2d(Y, -X);
